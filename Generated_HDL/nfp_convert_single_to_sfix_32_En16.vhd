-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\simpleController\nfp_convert_single_to_sfix_32_En16.vhd
-- Created: 2022-11-04 01:05:43
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: nfp_convert_single_to_sfix_32_En16
-- Source Path: simpleController/Subsystem/nfp_convert_single_to_sfix_32_En16
-- Hierarchy Level: 1
-- 
...
ENTITY nfp_convert_single_to_sfix_32_En16 IS
  PORT( nfp_in                            :   IN    std_logic_vector(31 DOWNTO 0);  -- ufix32
        nfp_out                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- sfix32_En16
        );
END nfp_convert_single_to_sfix_32_En16;


ARCHITECTURE rtl OF nfp_convert_single_to_sfix_32_En16 IS
  ...
  SIGNAL Data_Type_Conversion_out1        : unsigned(39 DOWNTO 0);  -- ufix40_En24
  ...
  SIGNAL Shift_Arithmetic1_out1           : unsigned(39 DOWNTO 0);  -- ufix40_En24
  SIGNAL Data_Type_Conversion1_out1_1     : unsigned(39 DOWNTO 0);  -- ufix40_En24
  ...
  SIGNAL Shift_Arithmetic2_out1           : unsigned(39 DOWNTO 0);  -- ufix40_En24
  SIGNAL Switch1_out1                     : unsigned(39 DOWNTO 0);  -- ufix40_En24
  SIGNAL Data_Type_Conversion1_out1_2     : signed(40 DOWNTO 0);  -- sfix41_En24
  SIGNAL Unary_Minus_cast                 : signed(41 DOWNTO 0);  -- sfix42_En24
  SIGNAL Unary_Minus_cast_1               : signed(41 DOWNTO 0);  -- sfix42_En24
  SIGNAL Unary_Minus_out1                 : signed(40 DOWNTO 0);  -- sfix41_En24
  SIGNAL Switch1_out1_1                   : signed(40 DOWNTO 0);  -- sfix41_En24
  SIGNAL Data_Type_Conversion2_out1       : signed(31 DOWNTO 0);  -- sfix32_En16
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= resize(Data_Type_Conversion1_out1 & '0', 40);
  ...
  Data_Type_Conversion1_out1_1 <= resize(Data_Type_Conversion1_out1 & '0', 40);
  ...
  Data_Type_Conversion1_out1_2 <= signed(resize(Switch1_out1, 41));

  Unary_Minus_cast <= resize(Data_Type_Conversion1_out1_2, 42);
  Unary_Minus_cast_1 <=  - (Unary_Minus_cast);
  Unary_Minus_out1 <= Unary_Minus_cast_1(40 DOWNTO 0);

  
  Switch1_out1_1 <= Data_Type_Conversion1_out1_2 WHEN In1 = '0' ELSE
      Unary_Minus_out1;

  Data_Type_Conversion2_out1 <= Switch1_out1_1(39 DOWNTO 8);
