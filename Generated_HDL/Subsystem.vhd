...
ARCHITECTURE rtl OF Subsystem IS
  ...
  COMPONENT nfp_convert_sfix_32_En16_to_single
  ...
  COMPONENT nfp_convert_single_to_sfix_32_En16
  ...
  FOR ALL : nfp_convert_sfix_32_En16_to_single
    USE ENTITY work.nfp_convert_sfix_32_En16_to_single(rtl);
  ...
  FOR ALL : nfp_convert_single_to_sfix_32_En16
    USE ENTITY work.nfp_convert_single_to_sfix_32_En16(rtl);
...
BEGIN
  u_simpleController_Subsystem_nfp_convert_sfix_32_En16_to_single : nfp_convert_sfix_32_En16_to_single
    PORT MAP( nfp_in => In2,  -- sfix32_En16
              nfp_out => Cast_To_Single_out1  -- single
              );

  u_nfp_sub_comp : nfp_sub_single
    PORT MAP( nfp_in1 => Cast_To_Single_out1,  -- single
  ...
  u_simpleController_Subsystem_nfp_convert_single_to_sfix_32_En16 : nfp_convert_single_to_sfix_32_En16
    PORT MAP( nfp_in => First_Order_System_out1,  -- single
              nfp_out => Cast_out1  -- sfix32_En16
              );
